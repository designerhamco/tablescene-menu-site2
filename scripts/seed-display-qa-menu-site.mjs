  ...
  return [
    {
      ...
      items: [
        ...
        },
        {
          ...
          recommended: true,
          sortOrder: 2,
          priceOptions: displayIceOnly(6400),
        },
        {
          name: "솔티드 카라멜 라떼",
        ...
        },
        {
          ...
          recommended: true,
          sortOrder: 5,
          priceOptions: displayIceOnly(6700),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          recommended: false,
          sortOrder: 4,
          priceOptions: [displayPriceOption("HOT", 5000, 0)],
        },
        {
          name: "콜드브루",
          setName: "COLD BREW",
...
function createDisplaySplitSampleCategories() {
  return [
    {
      name: "FRESH ADE & JUICE",
      sortOrder: 0,
      items: [
        {
          name: "자몽 허니 에이드",
...
function getStarterPlan({ withPromotion, denseMenu, templateKey, menuSiteId = null }) {
  ...
  const splitMenuCategories = isDisplayMenuA ? createDisplaySplitSampleCategories() : fullMenuCategories;
