  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .aube-table-page[data-align="center"] .aube-table-item { width: min(100%, 660px); margin-inline: auto; grid-template-columns: auto minmax(0, 420px); justify-content: center; align-items: center; text-align: center; }
