  ...
  return (
    <div className="space-y-6 break-keep">
      ...
      <section className="space-y-2">
        ...
        <p>· 무료 개인체험 및 유료서비스 이용 정보: 메뉴판 이름, 공개 주소, 템플릿 정보, 요금제, 구독 상태, 서비스 이용 기간</p>
      ...
      <section className="space-y-2">
        ...
        <p>· 무료 개인체험, 유료서비스 결제 및 정기구독 관리</p>
      ...
      <section className="space-y-2">
        ...
        <p>· 무료 개인체험 데이터: 체험 기간 및 종료 후 7일까지</p>
        <p>· 유료서비스 메뉴판 데이터: 유료서비스 이용기간 및 종료 후 7일까지</p>
      ...
      <section className="space-y-2">
        ...
        <p>다만 필수 항목에 대한 동의를 거부할 경우 회원가입, 로그인, 메뉴판 생성, 무료 개인체험, 유료서비스 결제, 정기구독 관리, 고객지원 및 메뉴링크 서비스 이용이 제한될 수 있습니다.</p>
      </section>
    </div>
  );
}
  ...
  return (
    <div className="space-y-6 break-keep">
      ...
      <section className="space-y-2">
        ...
        <p>마케팅 정보 수신 동의는 선택 사항이며, 동의하지 않아도 회원가입, 무료 개인체험, 유료서비스 결제 및 메뉴링크 서비스 이용에는 제한이 없습니다.</p>
