  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <>
            한국어로 입력한 내용을 영어, 중국어, 일본어로 번역할 수 있습니다. 전체 자동 번역은 5크레딧, 항목별 부분 자동 번역은 1크레딧을 사용합니다. 보유 AI 크레딧은 계정의 모든 메뉴판에서 함께 사용할 수 있습니다.
          </>
        ),
      },
    ],
    ...
    items: [
      {
        ...
        answer: (
          <>
            정가는 월 39,600원, 연 475,200원입니다. 오픈 할인 기준으로 월 결제는 월 19,800원, 연 결제는 연 190,000원이며 연 결제는 오픈 월결제 12개월 대비 약 20% 할인됩니다.
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            메뉴링크 디스플레이 메뉴판 생성 시 기본 AI 크레딧 26개가 계정에 지급됩니다. AI 설명 작성과 부분 자동 번역은 1크레딧, AI 메뉴 정리는 3크레딧, 전체 자동 번역은 5크레딧이 차감됩니다.
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            월 결제는 해지 신청 후에도 이미 결제된 이용 기간 종료일까지 사용할 수 있고, 다음 결제일부터 자동 결제가 중단됩니다. 이용 기간이 끝나면 디스플레이 메뉴보드는 비공개 처리되며 유료 구독 종료 후 90일간 복구 가능 상태로 보관됩니다. 90일 이후에는 메뉴보드 데이터와 업로드 이미지가 삭제되고 복구할 수 없습니다. 결제 내역과 약관 동의 기록 등 운영, 정산, 법적 대응에 필요한 기록은 보관될 수 있습니다.
          </>
        ),
      },
    ],
