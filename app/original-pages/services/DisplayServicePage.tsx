    ...
    items: [
      {
        ...
        answer: (
          <>
            정가는 월 19,900원, 연 238,800원입니다. 오픈 할인 기준으로 월결제는 월 14,900원, 연결제는 연 160,900원이며 연결제는 오픈 월결제 12개월 합계에서 10% 할인 후 100원 단위로 내림한 가격입니다.
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            계정의 첫 메뉴판 생성이 완료되면 AI 웰컴 크레딧 6개가 계정당 1회 제공됩니다. 추가 Display 메뉴판, 재구독, 정기 결제 갱신으로는 웰컴 크레딧이 추가되지 않습니다. AI 설명 작성과 부분 자동 번역은 1크레딧, AI 메뉴 정리는 3크레딧, 전체 자동 번역은 3크레딧이 차감됩니다.
          </>
        ),
      },
      {
