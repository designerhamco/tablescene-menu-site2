...
const ApplyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHeader 
        title="서비스 도입 신청" 
        subtitle="테이블씬의 올인원 솔루션을 시작해보세요."
        dark={false} 
      />
          ...
          <div className="bg-zinc-50 p-8 rounded-2xl border border-zinc-100 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input type="text" className="w-full px-4 py-3 rounded-xl border border-zinc-200 focus:outline-none focus:border-black transition-colors" placeholder="테이블씬 식당" />
              </div>
              <div className="space-y-2">
