...
> = {
  menu: {
    ...
    note:
      "Basic 유료 구독은 구독 1개당 Basic 메뉴판을 최대 3개까지 만들 수 있습니다. 결제 시 첫 메뉴판을 만들고, AI 기본 제공량은 구독 기준으로 지급됩니다.",
  },
  screen: {
    ...
    note:
      "MenuLink Display는 구독 1개당 Display 메뉴판 1개를 기준으로 제공됩니다. AI 기본 제공량은 구독 기준으로 지급되며, 현재는 전용 템플릿 준비 중입니다.",
  },
  order: {
