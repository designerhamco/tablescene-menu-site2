...
export const metadata: Metadata = {
  title: "테이블씬 디스플레이 준비 중 | TableScene",
  description: "테이블씬 디스플레이는 전용 템플릿 준비 후 신청할 수 있습니다.",
};
      ...
      <main className="min-h-screen bg-zinc-50 px-6 py-16 text-zinc-950">
        <div className="mx-auto w-full max-w-4xl">
          <section className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm md:p-12">
            <p className="mb-4 text-xs font-black uppercase tracking-[0.24em] text-zinc-400">TableScene Display</p>
            <h1 className="break-keep text-4xl font-black tracking-tight md:text-5xl">
              TableScene Display는 준비 중입니다.
            </h1>
            <p className="mt-5 max-w-2xl break-keep text-base font-semibold leading-relaxed text-zinc-500">
              Display 전용 템플릿 준비 후 신청할 수 있습니다. 현재는 결제, 템플릿 선택, 공개 주소 입력을 진행하지 않습니다.
            </p>
