...
function getApplyServices(displayCheckoutQaEnabled: boolean) {
  return [
  {
    ...
    note: "단일 월결제는 계정당 최초 1회, 결제수단 등록 후 30일 무료입니다. 멀티페이지는 오브 테이블·메종 마레 중 선택할 수 있으며, 오더 기능은 제공하지 않습니다.",
    type: "웹 메뉴판",
    cta: "베이직 만들기",
    href: "/apply/basic",
    active: true,
        ...
        <div className="mx-auto w-full max-w-6xl">
          <header className="border-b border-zinc-200 pb-10">
            ...
            <p className="mt-5 max-w-2xl break-keep text-base font-semibold leading-relaxed text-zinc-500">
              아티메뉴 다이닝은 단일·멀티페이지 월결제/연결제를 한 화면에서 비교할 수 있습니다. 단일 월결제는 계정당 최초 1회 30일 무료체험을 제공하며, 멀티페이지는 오브 테이블·메종 마레 중 선택할 수 있습니다.
