...
function getApplyServices(displayCheckoutQaEnabled: boolean) {
  ...
  {
    title: "아티메뉴 다이닝",
    description: "단일페이지는 할인·위젯, 멀티페이지는 할인·스마트호출을 제공합니다. 같은 페이지 유형 안에서 템플릿을 교체할 수 있습니다.",
    price: "단일 월 5,900원·연 63,700원 / 멀티 월 9,900원·연 106,900원",
    note: "단일 월결제는 계정당 최초 1회, 결제수단 등록 후 30일 무료입니다. 멀티페이지는 실제 디자인 템플릿 공개 전까지 신청할 수 없습니다. 오더 기능은 제공하지 않습니다.",
    type: "웹 메뉴판",
    cta: "베이직 만들기",
    href: "/apply/basic",
    active: true,
  ...
  {
    title: "아티메뉴 디스플레이",
    description: "사업자 전용 디스플레이 메뉴보드입니다. 구독 1건당 메뉴판 1개와 이미지·MP4 동영상 업로드 기능을 제공합니다.",
        ...
        <div className="mx-auto w-full max-w-6xl">
          <header className="border-b border-zinc-200 pb-10">
            ...
            <p className="mt-5 max-w-2xl break-keep text-base font-semibold leading-relaxed text-zinc-500">
              아티메뉴 다이닝은 단일·멀티페이지 월결제/연결제를 한 화면에서 비교할 수 있습니다. 단일 월결제는 계정당 최초 1회 30일 무료체험을 제공하며, 멀티페이지는 실제 디자인 템플릿 공개 후 신청을 엽니다.
