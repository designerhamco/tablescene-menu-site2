...
const PRICING_DATA: Record<ServicePricingKey, PricingData> = {
  basic: {
    ...
    plans: [
      {
        ...
        aiUsage: "구독 기준 기본 AI 크레딧 18개 제공",
      },
      {
        label: "연결제",
        badge: "약 40% 할인",
    ...
    features: [
      "Basic 메뉴판 최대 3개",
      "결제 시 첫 메뉴판 생성, 추가 메뉴판은 마이페이지에서 생성",
      "공개 메뉴판 링크",
      "QR 이미지 다운로드",
      "메뉴 / 가격 / 설명 직접 수정",
      "페이지 · 카테고리 관리",
      ...
      "반응형 화면 지원",
      "모바일 / 태블릿 / PC / 매장 화면 대응",
      "구독 기준 기본 AI 크레딧 18개 제공",
      "추가 메뉴판 생성 시 AI 기본 제공량 추가 지급 없음",
    ...
    plans: [
      {
        ...
        aiUsage: "구독 기준 기본 AI 크레딧 26개 제공",
      },
      {
        label: "연결제",
        badge: "약 60% 할인",
