...
export const DETAILED_FAQ_DATA: FAQCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: "Basic 구독으로 메뉴판을 몇 개까지 만들 수 있나요?",
        answer: (
          <>
            MenuLink Basic 유료 구독은 구독 1개당 Basic 메뉴판을 최대 3개까지 만들 수 있습니다.
            결제 시 첫 메뉴판을 만들고, 추가 메뉴판은 마이페이지에서 생성할 수 있습니다.
            체험 이용 기간에는 메뉴판 1개만 만들 수 있습니다.
          </>
        )
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <>
            요금제에 포함된 AI 기본 제공량은 구독 기준으로 제공됩니다. 메뉴링크 베이직은 18크레딧, 메뉴링크 디스플레이는 26크레딧을 기본 제공합니다.
            Basic 메뉴판을 추가로 생성하더라도 메뉴판 개수만큼 AI 기본 제공량이 추가 지급되지는 않습니다.
      ...
      {
        question: "메뉴판을 추가로 만들면 AI 크레딧도 추가로 지급되나요?",
        answer: (
          <>
            아닙니다. 요금제에 포함된 AI 기본 제공량은 구독 기준으로 제공되며, Basic 메뉴판을 추가로 생성하더라도 메뉴판 개수만큼 추가 지급되지는 않습니다.
            별도 충전한 AI 크레딧은 계정 기준으로 사용할 수 있습니다.
          </>
        )
      },
      {
