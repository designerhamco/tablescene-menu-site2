  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <>
            월 결제는 설명 작성 10회, 메뉴 정리 2회, 자동 번역 1페이지가 제공됩니다. 연 결제는 설명 작성 120회, 메뉴 정리 24회, 자동 번역 12페이지가 제공됩니다.
            월 결제의 미사용 제공량은 다음 달로 이월되지 않으며, 연간 제공량은 이용 기간 동안 사용할 수 있습니다.
          </>
        )
      },
      {
        ...
        answer: (
          <>
            자동 번역은 페이지 단위로 차감됩니다. 메뉴 페이지 1개를 번역하면 자동 번역 1페이지가 사용됩니다.
            한 페이지의 데이터 양이 매우 많은 경우 번역이 여러 번으로 나뉘어 처리될 수 있습니다.
          </>
        )
      },
      {
    ...
    items: [
      {
        ...
        answer: (
          <>
            월 결제는 매월 자동 갱신되며 부담 없이 시작할 수 있습니다. 연 결제는 1년 단위 이용권으로, 월 결제보다 더 저렴하게 이용할 수 있습니다.
          </>
        )
      },
      {
      ...
      },
      {
        ...
        answer: (
          <>
            이용 기간이 종료되면 메뉴판은 비공개 처리되며, 7일간 복구 가능 상태로 보관됩니다.
            7일 이후에는 메뉴판 데이터와 업로드 이미지가 삭제되며 복구할 수 없습니다.
