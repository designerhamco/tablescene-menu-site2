          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h2 className="type-subsection-title">호출 #{call.callNumber}</h2>
            ...
            {call.nextStatus ? (
              <form action={action}>
                ...
                <button disabled={pending} className={`min-w-32 rounded-full px-5 py-3 text-sm font-bold text-white disabled:opacity-60 ${call.nextStatus === "completed" ? "bg-emerald-800" : "bg-zinc-950"}`}>
