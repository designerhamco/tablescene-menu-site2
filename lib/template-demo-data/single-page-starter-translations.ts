...
const AUBE_TRANSLATIONS: SinglePageStarterTranslationBundle = {
  en: {
    ...
    items: {
      ...
      "vanilla-bean-milk": { name: "Vanilla Bean Milk", description: "Smooth milk with the gentle sweetness of vanilla bean" },
      ...
      "peach-earl-grey-ade": { name: "Peach Earl Grey Ade", description: "A bright sparkling ade with peach and Earl Grey" },
  ...
  zh: {
    ...
    items: {
      ...
      "vanilla-bean-milk": { name: "香草荚牛奶", description: "带有香草荚淡雅甜味的柔滑牛奶" },
      ...
      "peach-earl-grey-ade": { name: "蜜桃伯爵气泡饮", description: "蜜桃与伯爵茶香交织的清爽气泡饮" },
  ...
  ja: {
    ...
    items: {
      ...
      "vanilla-bean-milk": { name: "バニラビーンズミルク", description: "バニラビーンズのやさしい甘さを加えたなめらかなミルク" },
      ...
      "peach-earl-grey-ade": { name: "ピーチアールグレイエイド", description: "桃とアールグレイの香りを合わせた爽やかなエイド" },
