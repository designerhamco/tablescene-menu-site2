...
const REAL_MATCHA_TRANSLATIONS: SinglePageStarterTranslationBundle = {
  en: {
    site: {
      restaurantName: "REAL MATCHA",
      restaurantCategory: "Cafe",
      brandDescription: "A modern cafe centered on vivid Jeju matcha, coffee, and balanced bakery pairings.",
      introDescription: "Jeju matcha with vivid aroma and smooth cream, reimagined for a modern cafe.",
      menuCoverDescription: "Jeju matcha with vivid aroma and smooth cream, reimagined for a modern cafe.",
      aboutDescription: "Deep matcha and smooth cream in every cup.",
      footerNotices: ["Wi-Fi REAL_MATCHA · PW 1234-5678", "Instagram @real.matcha", ""],
    },
    pageTitle: "Menu",
    categoryNames: {
      "signature-coffee": "MATCHA SIGNATURE",
    ...
    items: {
      "real-matcha-cream-latte": { name: "Real Matcha Cream Latte", description: "A signature latte with vivid Jeju matcha and smooth cream" },
      "nutty-cream-latte": { name: "Nutty Cream Latte", description: "A creamy latte with a rich roasted nut finish" },
      "deep-matcha-cloud": { name: "Deep Matcha Cloud", description: "An intense matcha latte topped with light cream" },
      ...
      "matcha-terrine": { name: "Matcha Terrine", description: "A dense baked dessert with rich Jeju matcha" },
    },
    promotions: {
  ...
  zh: {
    site: {
      ...
      brandDescription: "以济州抹茶为核心，搭配咖啡与烘焙点心的现代咖啡馆。",
      introDescription: "以鲜明的济州抹茶香气与柔滑奶油呈现现代抹茶体验。",
      menuCoverDescription: "以鲜明的济州抹茶香气与柔滑奶油呈现现代抹茶体验。",
      aboutDescription: "每一杯都呈现抹茶的深度与奶油的柔滑。",
      footerNotices: ["Wi-Fi REAL_MATCHA · 密码 1234-5678", "Instagram @real.matcha", ""],
    },
    pageTitle: "菜单",
    categoryNames: {
      "signature-coffee": "抹茶招牌",
      "classic-coffee": "经典咖啡",
      "non-coffee": "非咖啡饮品",
      ade: "气泡饮",
      bakery: "烘焙甜点",
    ...
    categoryDescriptions: {},
    items: {
      "real-matcha-cream-latte": { name: "真抹茶奶油拿铁", description: "鲜明济州抹茶与柔滑奶油调制的招牌拿铁" },
      "nutty-cream-latte": { name: "坚果奶油拿铁", description: "带有浓郁坚果香的奶油拿铁" },
      "deep-matcha-cloud": { name: "浓抹茶云朵", description: "浓郁抹茶拿铁覆上轻盈奶油" },
      ...
      "matcha-terrine": { name: "抹茶软糕", description: "以浓郁济州抹茶烘烤的绵密甜点" },
    },
    promotions: {
  ...
  ja: {
    site: {
      ...
      brandDescription: "済州抹茶を中心に、コーヒーとベーカリーをバランスよく提案するモダンカフェです。",
      introDescription: "鮮やかな済州抹茶の香りとなめらかなクリームを現代的に楽しめます。",
      menuCoverDescription: "鮮やかな済州抹茶の香りとなめらかなクリームを現代的に楽しめます。",
      aboutDescription: "抹茶の深みとなめらかなクリームを一杯に。",
      footerNotices: ["Wi-Fi REAL_MATCHA · PW 1234-5678", "Instagram @real.matcha", ""],
    },
    pageTitle: "メニュー",
    categoryNames: {
      "signature-coffee": "抹茶シグネチャー",
    ...
    categoryDescriptions: {},
    items: {
      "real-matcha-cream-latte": { name: "リアル抹茶クリームラテ", description: "鮮やかな済州抹茶となめらかなクリームのシグネチャーラテ" },
      "nutty-cream-latte": { name: "ナッティクリームラテ", description: "香ばしいナッツクリームのラテ" },
      "deep-matcha-cloud": { name: "ディープ抹茶クラウド", description: "濃厚な抹茶ラテに軽やかなクリームを重ねました" },
      ...
      "matcha-terrine": { name: "抹茶テリーヌ", description: "濃厚な済州抹茶をしっとり焼き上げたデザート" },
    },
    promotions: {
...
const ROUND_FOCUS_TRANSLATIONS: SinglePageStarterTranslationBundle = {
  en: {
    ...
    items: {
      ...
      "long-black": { name: "Long Black", description: "Two bold shots with a clean finish" },
      ...
      "salted-cream-latte": { name: "Salted Cream Latte", description: "A latte topped with savory cream and smooth milk" },
    ...
    promotions: { ...COMMON_PROMOTIONS.en, "fig-butter-scone-closeout": { badgeText: "LAST BATCH" } },
  },
  zh: {
    site: {
      restaurantName: "ROUND ROASTERS",
    ...
    items: {
      ...
      "long-black": { name: "长黑咖啡", description: "双份浓缩的浓郁香气与清爽余味" },
      ...
      "salted-cream-latte": { name: "海盐奶油拿铁", description: "柔滑牛奶搭配微咸奶油的拿铁" },
      "citrus-mint-ade": { name: "柑橘薄荷气泡饮", description: "柑橘与薄荷香气的清爽气泡饮" },
      "earl-grey-peach-tea": { name: "伯爵蜜桃茶", description: "伯爵茶香与蜜桃的淡雅甜味" },
      "fig-butter-scone": { name: "无花果黄油司康", description: "加入无花果与发酵黄油烘烤的司康" },
      "lemon-madeleine": { name: "柠檬玛德琳", description: "带有柠檬香气的湿润玛德琳" },
    },
    promotions: { ...COMMON_PROMOTIONS.zh, "fig-butter-scone-closeout": { badgeText: "即将售罄" } },
  },
  ja: {
    site: {
      restaurantName: "ROUND ROASTERS",
    ...
    items: {
      ...
      "long-black": { name: "ロングブラック", description: "ダブルショットの深い香りとすっきりした後味" },
      ...
      "salted-cream-latte": { name: "ソルティクリームラテ", description: "なめらかなミルクに塩クリームを合わせたラテ" },
    ...
    promotions: { ...COMMON_PROMOTIONS.ja, "fig-butter-scone-closeout": { badgeText: "まもなく完売" } },
  },
};
