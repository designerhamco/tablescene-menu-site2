...
const MOCHA_FOREST_TRANSLATIONS: SinglePageStarterTranslationBundle = {
  en: {
    site: {
      ...
      restaurantCategory: "Cafe",
      brandDescription: "A coffee bar inspired by a dark forest, where deep roasts and chocolate flavors feel at home.",
    ...
    items: {
      "forest-mocha": { name: "Forest Mocha", description: "A signature mocha with dark chocolate, espresso, and smooth cream" },
      "hazelnut-cream-latte": { name: "Hazelnut Cream Latte", description: "Roasted hazelnut cream with bold espresso" },
      "matcha-cloud": { name: "Matcha Cloud", description: "Jeju matcha latte topped with light cream" },
      americano: { name: "Americano", description: "Dark chocolate sweetness with a full body" },
      "cafe-latte": { name: "Cafe Latte", description: "Balanced espresso and nutty milk" },
      "flat-white": { name: "Flat White", description: "A rich double shot with finely textured milk foam" },
      ...
      "salted-caramel-chocolate": { name: "Salted Caramel Chocolate", description: "Rich chocolate balanced with salted caramel" },
      "cacao-oat-milk": { name: "Cacao Oat Milk", description: "Cacao blended with nutty oat milk" },
      "black-tea-plum-ade": { name: "Black Tea Plum Ade", description: "A sparkling blend of black tea and bright plum" },
      ...
      "dark-chocolate-brownie": { name: "Dark Chocolate Brownie", description: "A moist brownie baked with rich dark chocolate" },
      "hazelnut-financier": { name: "Hazelnut Financier", description: "Roasted hazelnut and buttery richness" },
      "earl-grey-pound-cake": { name: "Earl Grey Pound Cake", description: "A tender pound cake scented with Earl Grey" },
      ...
      "mocha-walnut-cookie": { name: "Mocha Walnut Cookie", description: "A soft-baked cookie with mocha and walnuts" },
    },
    promotions: {
      ...COMMON_PROMOTIONS.en,
