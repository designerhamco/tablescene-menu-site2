  ...
  const starterTimeSales: MenuPageData["timeSales"] = fixture ? [] : [
    {
      ...
      items: [
        {
          id: `${siteId}-time-sale-basil-hot-target`,
        ...
        {
          id: `${siteId}-time-sale-basil-ice-target`,
          menuItemId: itemId(0, 0, 0),
    ...
    },
    {
      ...
      items: [
        {
          id: `${siteId}-time-sale-cappuccino-hot-target`,
        ...
        {
          id: `${siteId}-time-sale-cappuccino-ice-target`,
          menuItemId: itemId(0, 1, 4),
