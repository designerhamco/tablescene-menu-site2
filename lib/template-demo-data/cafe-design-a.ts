const CAFE_A_FEATURED_IMAGE = "/menu-templates/cafe_design_a/basil-featured.jpg";
...
export const CAFE_DESIGN_A_STITCH_SAMPLE = {
  site: {
    ...
    cover_image_url: CAFE_A_FEATURED_IMAGE,
    settings: {
  ...
  featured_slides: [
    {
      ...
      image_url: CAFE_A_FEATURED_IMAGE,
      image_path: null,
  ...
  time_sales: [
    {
      ...
      targets: [
        { target_item_name: "아메리카노", target_price_column_key: "hot", sale_price: 3500 },
        { target_item_name: "아메리카노", target_price_column_key: "ice", sale_price: 4000 },
      ],
    },
  ],
  pages: [
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              price_column_values: hotIce(5500, 6000),
            },
            {
              name: "플랫 화이트",
              set_name: "FLAT WHITE",
            ...
            },
            {
              ...
              price_column_values: hotIce(null, 5500),
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              price_column_values: hotIce(6000, 6500),
            },
            {
              name: "고구마 라떼",
              ...
              badge_label: "NEW",
              price_column_values: hotIce(5800, 6300),
            },
            {
              name: "블랙티 밀크티",
