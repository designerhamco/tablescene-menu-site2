...
export const TEMPLATE_BADGE_STYLE_PRESETS: Record<string, Partial<BadgeStyles>> = {
  display_menu_a: {
    ...
    new: { background_color: "#B8F1EA", text_color: "#064E52" },
    recommended: { background_color: "#D7F4F3", text_color: "#005F6B" },
    default: { background_color: "#08767D", text_color: "#FFFFFF" },
  },
  cafe_design_a: {
    best: { background_color: "#2AA36D", text_color: "#FFFFFF" },
    signature: { background_color: "#2AA36D", text_color: "#FFFFFF" },
    new: { background_color: "#2AA36D", text_color: "#FFFFFF" },
    recommended: { background_color: "#2AA36D", text_color: "#FFFFFF" },
  ...
  cafe_brew_chapter_a: {
    ...
    new: { background_color: "#E8DDC8", text_color: "#171717" },
    recommended: { background_color: "#171717", text_color: "#FFFFFF" },
    default: { background_color: "#6F5A37", text_color: "#FFFFFF" },
  },
  cafe_design_b: {
