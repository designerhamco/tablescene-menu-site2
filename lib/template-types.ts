...
export const TEMPLATE_EDITOR_LABELS = {
  ...
  price_list: {
    ...
    priceLabel: "가격",
    categoryNamePlaceholder: "예: 컷, 펌, 염색, 케어, 이용권, 상담",
    categoryGuideText: "서비스 그룹은 제공하는 서비스를 묶는 단위입니다. 예: 기본 관리, 프리미엄 관리, 이용권, 상담, 옵션",
    itemNamePlaceholder: "예: 여성 컷, 젤 네일 원컬러, 수분 진정 관리, PT 1회권",
    ...
    priceLabelPlaceholder: "예: 변동가, 문의, 월 99,000원, 10회권 250,000원",
    priceLabelHelperText: "표시용 가격을 입력하면 숫자 가격 대신 해당 문구가 우선 표시됩니다. 예: 변동가, 문의, 월 99,000원, 1회 30,000원, 10회권 250,000원",
    imageLabel: "서비스 이미지",
