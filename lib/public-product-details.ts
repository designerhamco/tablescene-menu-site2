...
export const publicBasicProducts: readonly PublicBasicProduct[] = [
  {
    ...
    shortName: "개인 1개월 체험",
    summary: "사업자 인증 없이 Basic 메뉴판 1개를 1개월 동안 이용하는 1회 결제 상품입니다.",
  ...
  },
  {
    ...
    shortName: "사업자 월결제",
    summary: "사업자 인증 후 Basic 메뉴판 1개를 매월 자동결제로 이용하는 정기구독 상품입니다.",
  ...
  },
  {
    ...
    shortName: "사업자 연결제",
    summary: "사업자 인증 후 Basic 메뉴판 1개를 연 자동결제로 이용하는 할인 정기구독 상품입니다.",
