...
export const personalTrialBasicProduct = {
  ...
  name: "아티메뉴 베이직 개인 1개월 체험",
  label: "아티메뉴 베이직 개인 1개월 체험",
  description: "사업자 인증 없이 아티메뉴 베이직 템플릿 메뉴판을 1개월 동안 체험합니다.",
...
export const businessBasicMonthlyProduct = {
  ...
  name: "아티메뉴 베이직 월결제",
  label: "아티메뉴 베이직 월결제",
  description: "사업자 인증 후 아티메뉴 베이직 메뉴판을 월 자동결제로 이용합니다.",
...
export const businessBasicYearlyProduct = {
  ...
  name: "아티메뉴 베이직 연결제",
  label: "아티메뉴 베이직 연결제",
  description: "사업자 인증 후 아티메뉴 베이직 메뉴판을 연 자동결제로 이용합니다.",
  plan_type: "business_basic",
  payment_type: "subscription",
