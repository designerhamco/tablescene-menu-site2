...
- 오브 테이블 B (`dining_aube_table_b`, `coming_soon`)
...
- 2026-08-31 오브 테이블 B production build에서 1440×900·1180×820의 왼쪽 페이지 메뉴/오른쪽 콘텐츠, 390×844의 가로 스와이프 상단 페이지 탭을 확인했다. 하단 dot 없이 페이지 클릭이 전환되고 모든 크기에서 가로 overflow가 없으며 A타입의 dot·Prev/Next 회귀도 통과했다.
