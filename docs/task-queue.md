...
- `TODO` 고객센터 전용 디자인 — 현재 FAQ·AI 상담·1:1 문의 기능은 유지하되 정보 구조, 검색·카테고리, 문의 진입, 모바일 밀도를 새 사이트 디자인 시스템에 맞게 재구성
- `TODO` AI 상담 콘텐츠·대화 UX 보정 — 실제 질문 세트로 답변 정확도·장문·중복·잘못된 단정·1:1 문의 전환을 검토하고, 초기 질문·답변 구조·로딩·오류·모바일 채팅창을 고객센터 디자인과 함께 다듬기
