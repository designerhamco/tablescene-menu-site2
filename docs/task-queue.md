...
- `DONE` 미리보기 상단 UI 정리 — 브라우저 안내의 Guest와 주소형 장식을 제거하고 원형 프로필·더보기·확대/축소만 유지. 단일·멀티페이지의 접힌 기기 선택기는 상단 중앙 dark pill로 변경
...
- `DONE` 디자인 엔진 최종 자동 회귀 — PR #211 병합 기준 공개·판매 템플릿 31개 PC·모바일 화면의 HTTP·빈 화면·overflow·이미지·요청·console/page error·axe critical/serious와 미리보기 행동 검사 실패 0건
