...
- `DONE` 다이닝 신규 SKU·결제 entitlement 연결과 Production 제약 적용 — 단일 월 5,900원·연 63,720원, 멀티 월 9,900원·연 106,920원, 서버 등급 검증·갱신·환불·복구 연결과 기존 고객 레거시 SKU 보존
- `DONE` 디스플레이 이미지·동영상 템플릿 통합 가격 — 월 정가 19,900원·오픈할인 14,900원, 연 160,920원, 기존 연 결제의 현재 환불 기준은 소급 변경하지 않음
