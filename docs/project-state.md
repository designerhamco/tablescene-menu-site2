...
현재 작업 브랜치: `codex/display-unified-pricing`
...
- 디스플레이 이미지·동영상 템플릿은 월 정가 19,900원·오픈할인 14,900원으로 통일하고 연간은 160,920원 적용
- 기존 디스플레이 고객은 다음 갱신부터 인하 가격을 적용하되 이미 결제된 연간 기간의 환불 재정산 기준은 소급 변경하지 않음
