...
현재 Hobby 플랜의 Dashboard 로그 조회 범위는 최근 1시간으로 제한된다. 따라서 이 감사 시각에는 당일 03:00~04:00 실행의 성공·실패 기록을 확인할 수 없었다. 다음 예정 실행 후 1시간 안에 Vercel Logs를 확인해야 실제 실행 결과를 확정할 수 있다.
