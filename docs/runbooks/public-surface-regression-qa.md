...
- 단일페이지 4종 × PC·태블릿·모바일: 대표 상품명·텍스트칩·가격·설명은 대응 메뉴 역할의 계산 스타일을 유지하면서 PC·태블릿 1.25배·모바일 1배, 그 외 설명 역할 불일치 0건
