...
- 라운드 포커스 PC·태블릿 3열 실측 폭 차이 1px 이하, 선데이 라인 PC·태블릿 행 간격 추가분 3~12px, 모카 카테고리 유동 배율 1.14 확인
